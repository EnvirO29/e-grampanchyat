                    ...
                    <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
                        <div class="nav-outer">
                            <ul class="nav navbar-nav">
                                ...
                                <li id="Header_A3" class="active"><a href="dharohar.php">Heritage</a></li>
                                ...
                                <li id="Header_A10" class="dropdown"><a href="feedback.php">Opinion</a> </li>
                                 ...
                                 <li id="Header_A12" class="dropdown"><a href="birth.php">Birth Certificate</a> </li>
                                  ...
                                  <li id="Header_A12" class="dropdown"><a href="death.php">Death Certificate</a> </li>
...
<div class="breadcrumb">
    <div class="container">
        ...
        <div class="blog-post wow fadeInUp">
          <a href="https://docs.google.com/forms/d/e/1FAIpQLSf_Q3AZ1c3OOf-7YjuA5HL1tzn2M_-MBV0CWav7_ofBC1K8EA/viewform?usp=sf_link"> <h1> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Click Here to Add Death Certitificate</h1></a>
                        ...
                        <div class="col-md-9">
                            <?php
                                    ...
                                    <div class="blog-post outer-bottom-xs wow fadeInUp">
                                        <a href="#">
                                            <img class="img-responsive" src="images/banner/<?php echo $val['tImage']; ?>" alt="Entrance" /></a>
                                        <h1><a href="javascript:void(0);"><?php echo $val['place_name']; ?></a></h1>
                                        <span class="date-time">Founded Sun. <?php echo $val['place_date']; ?></span>
            ...
            <div class="item">
                <div class="products">
                    <div class="hot-deal-wrapper">
                        <div class="image">
                            <img src="images/banner/<?php echo $val['tImage']; ?>" alt="Chief Minister" />
                        </div>
                    </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    ...
                    <div class="module-body">
                        <ul class="list-unstyled">
                            ...
                            <li class="first"><a title="Aadhar Card" href="https://www.indiapost.gov.in/">Aadhar Card</a></li>
                ...
                <div class="col-xs-12 col-sm-6 col-md-2">
                    ...
                    <div class="module-body">
                        <ul class="list-unstyled">
                            ...
                            <li class="first"><a title="Aadhar Card" href="https://uidai.gov.in/my-aadhaar/get-aadhaar.html" target="_blank">Adhar Card</a></li>
