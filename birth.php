                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li id="Header_A10" class="dropdown"><a href="feedback.php">Opinion</a> </li>
                                 ...
                                 <li id="Header_A12" class="dropdown"><a href="birth.php">Birth Certificate</a> </li>
                                  <li id="Header_A12" class="dropdown"><a href="contact.php">Marriage Certificate</a> </li>
...
<div class="breadcrumb">
    <div class="container">
        ...
        <div class="blog-post wow fadeInUp">
          <a href="Online Birth Certificate System\obcs\index.php"> <h1> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Click Here to Add Birth Certitificate</h1></a>
         o
