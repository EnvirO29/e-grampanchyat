										   ...
										   <div class="product-item-holder size-big single-product-gallery small-gallery" style="padding-bottom: 0px;">
												...
												<div id="owl-single-product">
                                                    <div class="single-product-gallery-item" id="slide1">
                                                        <a href="https://pravara.in/pravara-public-school-loni/about-us/">ACADEMIC / PROFESSIONAL ACHIEVEMENTS</a>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    ...
                    <div class="module-body">
                        <ul class="list-unstyled">
                            ...
                            <li class="first"><a title="Department of Loni, Water Resources, Water Supply and Pravranagar" href="https://guj-nwrws.gujarat.gov.in/" target="_blank">Department of Loni, Water Resources, Water Supply and Pravranagar</a></li>
                            <li class="first"><a title="Maharashtra Energy Development Corporation Limited" href="https://www.mahaurja.com/meda/">Gujarat Energy Development Corporation Limited</a></li>
                        </ul>
                    </div>
                </div>
