                    ...
                    <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
                        <div class="nav-outer">
                            <ul class="nav navbar-nav">
                                ...
                                <li id="Header_A5" class="active"><a href="javascript:void(0);" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown">Incumbent</a>
                                ...
                                <li id="Header_A10" class="dropdown"><a href="feedback.php">Opinion</a> </li>
                                 ...
                                 <li id="Header_A12" class="dropdown"><a href="contact.php">Birth Certificate</a> </li>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-9">
                        <div class="scroll-tabs wow fadeInUp">
                            <div class="more-info-tab clearfix ">
                                <a href="https://findmygov.in/en/maharashtra/ahmadnagar/rahata-block/loni-bk"><h3 class="new-product-title pull-left">Panchayat office bearer</h3></a>
                            </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    ...
                    <div class="module-body">
                        <ul class="list-unstyled">
                            <li class="first"><a title="ગ્રામ ગૃહનિર્માણ અને ગ્રામ વિકાસ વિભાગ" href="https://rdd.maharashtra.gov.in/en" target="_blank">Department of Rural Housing and Rural Development</a></li>
