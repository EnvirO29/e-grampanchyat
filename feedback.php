        ...
        <div class="container">
            <div class="header-top-inner">
                <div class="cnt-account" style="color: darkblue;">
                    ...
                    <a id="blinker" style="font-size:25px;" href="https://bhulekh.mahabhumi.gov.in/" target="_blank">Click here to get the excerpt from 7/12. </a>
					<a id="blinker" style="font-size:25px;"href="http://epaper.lokmat.com/" target="_blank">Please click here and see the newspaper</a>
                    ...
                    <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
                        <div class="nav-outer">
                            <ul class="nav navbar-nav">
                                ...
                                <li id="Header_A10" class="active"><a href="feedback.php">Opinion</a> </li>
                        ...
                        <div class="row">
                            <div class="col-md-9 contact-form">
                                ...
                                <div class="col-md-12 outer-bottom-small">
                                    <p style="color:red;">Note: - Your opinion should be for village and village development only.</p>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="info-title">Name of the village / city <span>*</span></label>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="info-title" for="exampleInputComments">Opinion <span>*</span></label>
